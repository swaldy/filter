...
for run_iter in range(10):
    for size_iter in sizes:
        for threshold in thresholds:
            ...
            plt.savefig('/eos/user/s/swaldych/smart_pix/dataset_3s_400NoiseThresh/'+results_dir+'/classes_'+sensor_geom+'_0P'+str(threshold - int(threshold))[2:]+'thresh_run'+str(run_iter)+'.png')
            plt.close()
